...
**This code is a fork of _jaku/SnapCameraPreservation_ on steroids 💪**
...
You get the full decentralized control and you can use _Snap Camera_ until Doomsday.
...
_The client application is required to apply the filters to your webcam ([Download Snap Camera](https://github.com/ptrumpis/snap-camera-server/discussions/6))_
